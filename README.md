...
* Control files for simulations are archived together with the data that were generated by them. Additionally including them below:
    ...
    - [Eight taxa_balanced](https://github.com/noraracht/subsample_support_scripts/blob/main/control_balanced_unif_0.00001.tar.gz)
    - [Eight taxa_unbalanced (caterpillar)](https://github.com/noraracht/subsample_support_scripts/blob/main/control_caterpillar_unif_0.00001.tar.gz)
